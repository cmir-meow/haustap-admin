...
<?php include dirname(__DIR__) . "/client/includes/header.php"; ?>
  <main>
    ...
    <button class="cleaning-type-btn">Penthouse</button>
    <div class="cleaning-cards-container">
      <div class="cleaning-cards-row">
        <div class="cleaning-card">
          ...
          <div class="cleaning-title">Basic Cleaning &ndash; 3 Cleaners</div>
          <div class="cleaning-price">₱2,500</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>Living room, dining, bedrooms: sweep, mop, dust, trash removal</li>
            <li>Large windows & mirrors: wipe</li>
            <li>Balconies: sweep & mop</li>
          </ul>
        </div>
        <div class="cleaning-card">
        ...
        <div class="cleaning-title">Standard Cleaning &ndash; 3-4 Cleaners</div>
          <div class="cleaning-price">₱4,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Basic tasks</li>
            <li>Kitchen: stove, counters, cabinets wiped</li>
            <li>Bathrooms: toilet, shower, sink scrubbing</li>
      ...
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Deep Cleaning &ndash; 4 Cleaners</div>
          <div class="cleaning-price">₱6,500</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Standard tasks</li>
            <li>Scrub grout & tiles</li>
            <li>Clean behind large appliances</li>
