...
<?php include dirname(__DIR__) . "/client/includes/header.php"; ?>
  <main>
    ...
    <button class="cleaning-type-btn">Mansion Smaller</button>
    <div class="cleaning-cards-container">
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Basic Cleaning &ndash; 4-5 Cleaner</div>
          <div class="cleaning-price">₱8000</div>
        ...
        <div class="cleaning-title">Standard Cleaning &ndash; 5 Cleaners</div>
          ...
          <ul class="cleaning-inclusions">
            ...
            <li>Kitchen deep clean (multiple areas)</li>
            <li>Bathrooms scrubbed & sanitized</li>
            <li>Furniture base cleaning</li>
          </ul>
        </div>
      </div>
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Deep Cleaning &ndash; 6 Cleaners</div>
          ...
          <ul class="cleaning-inclusions">
            ...
            <li>Upholstery & carpet deep clean</li>
