...
<?php include dirname(__DIR__) . "/client/includes/header.php"; ?>
  <main>
    ...
    <button class="cleaning-type-btn">Mansion larger</button>
    <div class="cleaning-cards-container">
      <div class="cleaning-cards-row">
        <div class="cleaning-card">
          ...
          <div class="cleaning-title">Basic Cleaning &ndash; 6 Cleaners</div>
          <div class="cleaning-price">₱15,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All areas swept, mopped, dusted</li>
            <li>Trash collection</li>
            <li>Window/glass wipe</li>
          </ul>
        </div>
        <div class="cleaning-card">
        ...
        <div class="cleaning-title">Standard Cleaning &ndash; 6-7 Cleaners</div>
          <div class="cleaning-price">₱25,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Basic tasks</li>
            <li>Kitchen & multiple bathrooms deep clean</li>
            <li>Furniture base & under cleaning</li>
          </ul>
        </div>
      </div>
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Deep Cleaning &ndash; 8 Cleaners</div>
          <div class="cleaning-price">₱40,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Standard tasks</li>
            <li>Floor polishing & grout cleaning</li>
            <li>Behind appliances/furniture</li>
            <li>Carpet shampoo</li>
            <li>Disinfection full house</li>
          </ul>
        </div>
      </div>
