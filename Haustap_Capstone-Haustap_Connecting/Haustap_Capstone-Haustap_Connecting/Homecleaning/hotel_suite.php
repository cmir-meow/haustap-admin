...
<?php include dirname(__DIR__) . "/client/includes/header.php"; ?>
  <main>
    ...
    <button class="cleaning-type-btn">Hotel-Suite</button>
    <div class="cleaning-cards-container">
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-card">
          ...
          <div class="cleaning-title">Standard Cleaning &ndash; 2-3 Cleaners</div>
          <div class="cleaning-price">₱3,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Basic tasks</li>
            <li>Kitchenette wipe & sanitize</li>
            <li>Bathrooms deep scrub</li>
            <li>Under furniture clean</li>
          </ul>
        </div>
      </div>
      <div class="cleaning-cards-row">
        <div class="cleaning-card wide">
          ...
          <div class="cleaning-price">₱5,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
