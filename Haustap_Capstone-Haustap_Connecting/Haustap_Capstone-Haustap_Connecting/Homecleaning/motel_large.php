...
<?php include dirname(__DIR__) . "/client/includes/header.php"; ?>
  <main>
    ...
    <button class="cleaning-type-btn">Motel-Large</button>
    <div class="cleaning-cards-container">
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Standard Cleaning &ndash; 6-7 Cleaner</div>
