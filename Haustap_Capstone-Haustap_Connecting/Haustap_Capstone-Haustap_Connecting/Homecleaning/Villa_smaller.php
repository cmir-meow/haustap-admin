...
<?php include dirname(__DIR__) . "/client/includes/header.php"; ?>
  <main>
    ...
    <button class="cleaning-type-btn">Villa Smaller</button>
    <div class="cleaning-cards-container">
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Basic Cleaning &ndash; 3 Cleaners</div>
          ...
          <ul class="cleaning-inclusions">
            <li>Living room, bedrooms, dining cleaned</li>
            <li>Trash removal</li>
            <li>Mirrors/windows wiped</li>
          </ul>
        </div>
        <div class="cleaning-card">
        ...
        <div class="cleaning-title">Standard Cleaning &ndash; 3 Cleaners</div>
          <div class="cleaning-price">₱5,500</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Basic tasks</li>
            <li>Kitchen cleaning</li>
            <li>Bathroom scrubbing</li>
      ...
      <div class="cleaning-cards-row">
        ...
        <div class="cleaning-title">Deep Cleaning &ndash; 4 Cleaners</div>
          <div class="cleaning-price">₱9,000</div>
          <div class="cleaning-inclusions-title">Inclusions:</div>
          <ul class="cleaning-inclusions">
            <li>All Standard tasks</li>
            <li>Floor scrubbing & grout cleaning</li>
            <li>Behind appliances</li>
            <li>Carpet vacuum/shampoo</li>
            <li>Disinfection</li>
          </ul>
        </div>
      </div>
